        ...
        <section className="flex flex-col max-w-6xl mx-auto">
            ...
            {/* Timeline principal */}
                <div className="space-y-6">
                    ...
                    <div key={log.id} className="relative pl-12 group ml-4 mr-16">
                        {/* Linha vertical e ponto */}
                        <div className="absolute left-0 top-4 bottom-0 w-px bg-linear-to-b from-[#2C5159] via-[#918848] to-transparent"></div>
                ...
                <div className="flex flex-col mx-auto space-y-8">
                    {/* Card de meta atual */}
                    <div className="bg-linear-to-r from-[#010421] to-[#2B3276] rounded-xl p-6 text-white ml-8 mr-8">
                    ...
                    {/* Card de tags */}
                    <div className="bg-linear-to-r from-[#010421] to-[#2B3276] rounded-xl p-6 shadow-sm border border-gray-100  ml-8 mr-8">
                    ...
                    <div className="bg-[#F1F0F2] rounded-xl p-6 ml-4 mr-16">
